...
public class MyFoodMaterialAdapter extends BaseExpandableListAdapter {
	...
	public MyFoodMaterialAdapter(Context context,
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		MyFoodMaterialChildAdapter adapter = new MyFoodMaterialChildAdapter(
				context, list, flag,
