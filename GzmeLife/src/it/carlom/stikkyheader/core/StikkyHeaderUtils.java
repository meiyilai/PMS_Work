...
public class StikkyHeaderUtils {
    ...
    public static void setOnTouchListenerOnHeader(@NonNull View header, @Nullable View scrollingView, @Nullable final View.OnTouchListener onTouchListenerOnHeaderDelegate, final boolean allowTouchBehindHeader) {
        ...
        final WeakReference<View> scrollingViewReference = new WeakReference<View>(scrollingView);
        final WeakReference<View> headerReference = new WeakReference<View>(header);
        final WeakReference<View.OnTouchListener> touchListenerReference = new WeakReference<View.OnTouchListener>(onTouchListenerOnHeaderDelegate);
